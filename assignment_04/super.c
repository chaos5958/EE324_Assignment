...
static int my_id;
static node_info_t childinfo_arr[MAX_CHILD_NUM];
static node_info_t sn_neighbor_info; 
            ...
            if(has_data)
            {
                switch(msg_type)
                {
                    ...
                    case FILEINFO_FROM_CHD_TO_SUP:
                        ...
                        //unvalid client (unused now - add_fileinfo return true)
                        else
